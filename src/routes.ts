...
import { nutritionistProfileRouter } from './modules/nutritionist-profile/routes/nutritionist-profile.routes';
...
router.use('/nutritionist-profile', nutritionistProfileRouter);
